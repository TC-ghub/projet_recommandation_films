...
Objectif : concevoir un moteur de recommandation basé sur les données IMDb et TMDb.


# Objectif & Enjeux


Vous êtes un Data Analyst freelance. Un cinéma en perte de vitesse  vous contacte. Il a décidé de passer le cap du digital en créant un site Internet taillé pour les locaux.
